                      ...
                      <TableBody>
                        {startupEvals.map((e: any) => (
                          <TableRow key={e.id} className="hover:bg-slate-50/50">
                            ...
                            <TableCell className="text-xs text-slate-500 max-w-[140px] print:max-w-none py-2">
                              <p className="truncate print:whitespace-normal print:overflow-visible" title={e.comments}>{e.comments || <span className="italic text-slate-300">—</span>}</p>
                            </TableCell>
                          </TableRow>
                        ))}
